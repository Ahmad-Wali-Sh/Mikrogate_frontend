...
export default function AmendmentTasks() {
     ...
     ProjectReturn('Amendment')?.[0]?.id && axios
      .get(
        TASK_URL +
          ...
          }&project=${ProjectReturn('Amendment')?.[0]?.id}&deadline_after=&deadline_before=&tag=&stage=&archieved=${assignedFilter.archivedShow ? '' : false}&assigned__id=&created_after=&created_before=&contract__contract_id=${
